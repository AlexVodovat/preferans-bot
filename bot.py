...
tests = {
    "test_basic": [
        ...
        },
        {
            ...
            "a": ["3", "4", "Либо 3 либо 4"],
            "correct": 2,
            "explanation": "В преферанс можно играть вчетвером, тогда обин будет "сидеть" на прикупе, либо втроем, тогда прикуп ничей"
        },
        {
    ...
    "test_raspas": [
        ...
        {
            "q": "Цель распаса?",
            "a": ["Сдающий", "Слева от сдающего", "Игрок с минимальной картой"],
            "correct": 1,
            "explanation": "Первым ходит игрок, сидящий слева от сдающего."
        }
    ],
